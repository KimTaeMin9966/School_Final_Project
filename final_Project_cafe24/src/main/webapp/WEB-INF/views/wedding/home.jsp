							...
							<div class="item-inner-wrapper">
								<div class="image-wrapper">
									<a
										...
										src="${pageContext.request.contextPath}/resources/wedding/images/companys.png"
										class="_loaded">
									</a>
								</div>
								<h3 class="title">
							...
							<div class="item-inner-wrapper">
								<div class="image-wrapper">
									<a
										href="/wedding/list">
										<img alt="" data-story-image=""
										src="${pageContext.request.contextPath}/resources/wedding/images/checklist.png"
										class="_loaded">
									</a>
								</div>
								<h3 class="title">
							...
							<div class="item-inner-wrapper">
								<div class="image-wrapper-proportional-height">
									<div class="image-wrapper">
										<a
											href="/wedding/hall">
											<img src="${pageContext.request.contextPath}/resources/wedding/images/메인홀.jpg"
											class="_loaded">
										</a>
									</div>
								</div>
						...
						<div class="style-news-item normal-item even">
							<div class="item-inner-wrapper">
								<div class="image-wrapper">
									<a
										href="/wedding/studio">
										<img src="${pageContext.request.contextPath}/resources/wedding/images/44.png"
										class="_loaded">
									</a>
								</div>
								<h3 class="title">
							...
							<div class="item-inner-wrapper">
								<div class="image-wrapper">
									<a
										href="/wedding/send">
										<img alt="" data-story-image=""
										src="${pageContext.request.contextPath}/resources/wedding/images/메인청첩장.png"
										class="_loaded">
									</a>
								</div>
								<h3 class="title">
