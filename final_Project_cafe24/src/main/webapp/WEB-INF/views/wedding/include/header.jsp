...
<head>
	...
	<!-- Site Icons -->
	<link rel="shortcut icon" href="${pageContext.request.contextPath}/resources/wedding/images/favicon.ico" type="image/x-icon">
	<link rel="apple-touch-icon" href="${pageContext.request.contextPath}/resources/wedding/images/apple-touch-icon.png">
	...
	<!-- Offline JS -->
	<script src="${pageContext.request.contextPath}/resources/wedding/plugins/jQuery/jQuery-2.1.4.min.js?ver=20181215001"></script>
	<script src="${pageContext.request.contextPath}/resources/wedding/js/modernizr-3.6.0.min.js?ver=20181215001"></script>
	<script src="${pageContext.request.contextPath}/resources/wedding/js/bowser.js?ver=20181215001"></script>
	<script src="${pageContext.request.contextPath}/resources/wedding/js/custom.js?ver=20181215001"></script>
	<script src="${pageContext.request.contextPath}/resources/wedding/js/bootstrap.min.js?ver=20181215001"></script>
	<script src="${pageContext.request.contextPath}/resources/wedding/js/jquery.magnific-popup.min.js?ver=20181215001"></script>
	<script src="${pageContext.request.contextPath}/resources/wedding/js/modal.js?ver=20181215001"></script>
	<script src="${pageContext.request.contextPath}/resources/wedding/js/upload.js?ver=20181215001"></script>
	
	<!-- Offline CSS -->
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/wedding/css/main.css?ver=20181215001">
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/wedding/css/bootstrap.min.css?ver=20181215001">
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/wedding/css/magnific-popup.css?ver=20181215001">
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/wedding/css/style.css?ver=20181215001">
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/wedding/css/custom.css?ver=20181215001">
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/wedding/css/icomoon.css?ver=20181215001">
	<!-- Auto Include Files -->
</head>
	...
	<div id="mobile-menu" class="mm-menu mm-fullscreen mm-multiline mm-offcanvas mm-top mm-front mm-hasnavbar-top-1 primary-menu-opened mm-current mm-opened">
		<div class="mm-panels">
			<div class="mm-panel mm-opened mm-current" id="mm-1">
				<ul class="mmenu-item menu-first-level flex-container mm-listview">
	...
	<div id="mm-0" class="mm-page mm-slideout">
		<div id="page" class="_position-special">
			...
			<header class="force-repaint-width move-header-if-lt-ie10 header__bg-transparent" id="header-main">
				<!-- logo -->
				<div class="logo">
					<a tabindex="5" href="/wedding">MADE WEDDING</a>
				</div>
			...
			<header data-component-container="heroComponent" data-hero-layer-opacity="opacity20" data-hero-layer-color="BLACK"
				...
				<div class="hero-background-image-large-wrapper">
					...
					<img alt="메인 이미지입니다." id="slide" src="${pageContext.request.contextPath}/resources/wedding/images/imagechange/메인1.png">
