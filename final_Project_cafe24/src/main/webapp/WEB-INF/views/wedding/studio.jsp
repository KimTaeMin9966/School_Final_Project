				...
				<header class="style-news-header">
					...
					<h2 class="title">
						<font style="vertical-align: inherit;">
							<font style="vertical-align: inherit;">부산의 대표적인 스튜디오 업체 </font>
						</font>
					</h2>
					<p class="eyebrow"></p>
				</header>
				<div class="row">
					<div class="col col-xs-12 col-sm-4 col-md-4 col-lg-4 ">
						<div class="panel panel-default panel-front">
							...
							<div class="panel-body">
								<a href="/wedding/studio/area1"><h3>진구 스튜디오</h3></a>
								...
								<div class="row">
									...
									<div class="col-xs-6 col-sm-12 col-md-6">
										<div class="text-center">
											<a href="/wedding/studio/area1" rel="nofollow" class="btn btn-info btn-sm" role="button">진구 스튜디오</a>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col col-xs-12 col-sm-4 col-md-4 col-lg-4 ">
						<div class="panel panel-default panel-front">
							...
							<div class="panel-body">
								<a href="/wedding/studio/area2"><h3> 해운대구 스튜디오</h3></a>
								...
								<div class="row">
									...
									<div class="col-xs-6 col-sm-12 col-md-6">
										<div class="text-center">
											<a href="/wedding/studio/area2" rel="nofollow" class="btn btn-info btn-sm" role="button">해운대 스튜디오</a>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col col-xs-12 col-sm-4 col-md-4 col-lg-4 ">
						<div class="panel panel-default panel-front">
							...
							<div class="panel-body">
								<a href="/wedding/studio/area3"><h3> 연제구 스튜디오</h3></a>
								<p>Located in the heart of downtown Sacramento, only steps
									...
									charm. This exquisite venue, originally built in 1894, with
									charming Victorian architecture and immaculate, manicured
									grounds, offers a gorgeous and unique atmosphere for your
									wedding.</p>
								<div class="row">
									<div class="col-xs-6 col-sm-12 col-md-6"></div>
									<div class="col-xs-6 col-sm-12 col-md-6">
										<div class="text-center">
											<a href="/wedding/studio/area3" rel="nofollow" class="btn btn-info btn-sm" role="button">연제스튜디오</a>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="row">
					<div class="col col-xs-12 col-sm-4 col-md-4 col-lg-4 ">
						<div class="panel panel-default panel-front">
							...
							<div class="panel-body">
								<a href="/wedding/studio/area4"><h3>동구 스튜디오</h3></a>
								<p>All-encompassing of Colorado's most beautiful and
									...
									lifetime. Here on 3,500 acres at the oldest guest ranch in the
									State of Colorado, say ‘I do’ surrounded by century old pines,
									flowing creeks, and 360-degree mountain views. As your guests
									make their way to the magnificent log ballroom </p>
								<div class="row">
									<div class="col-xs-6 col-sm-12 col-md-6"></div>
									<div class="col-xs-6 col-sm-12 col-md-6">
										<div class="text-center">
											<a href="/wedding/studio/area4" rel="nofollow" class="btn btn-info btn-sm" role="button">동구 스튜디오</a>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col col-xs-12 col-sm-4 col-md-4 col-lg-4 ">
						<div class="panel panel-default panel-front">
							...
							<div class="panel-body">
								<a href="/wedding/studio/area5"><h3>기장 스튜디오</h3></a>
								<p>Like a Temecula fine wine, Wedgewood Weddings Galway
									...
									barn, and a dressing suite you'll want to sign a lease on.
									You'll be trendy and legendary when you let your </p>
								<div class="row">
									<div class="col-xs-6 col-sm-12 col-md-6"></div>
									<div class="col-xs-6 col-sm-12 col-md-6">
										<div class="text-center">
											<a href="/wedding/studio/area5" rel="nofollow" class="btn btn-info btn-sm" role="button">기장 스튜디오</a>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col col-xs-12 col-sm-4 col-md-4 col-lg-4 ">
						<div class="panel panel-default panel-front">
							...
							<div class="panel-body">
								<a href="/wedding/studio/area6"><h3>동래 스튜디오</h3></a>
								<p>Experience one of the most dramatic coastlines in
									California at Wedgewood Weddings Carmel. Whether you choose our
									...
									with views of a natural </p>
								<div class="row">
									<div class="col-xs-6 col-sm-12 col-md-6"></div>
									<div class="col-xs-6 col-sm-12 col-md-6">
										<div class="text-center">
											<a href="/wedding/studio/area6" rel="nofollow" class="btn btn-info btn-sm" role="button">동래 스튜디오</a>
										</div>
									</div>
								</div>
							</div>
