...
@Controller
@RequestMapping("/wedding/studio/area8/*")
public class WeddingStudioArea8Controller {
	private static final Logger logger = LoggerFactory.getLogger(WeddingStudioArea8Controller.class);
	...
	public void detail1GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(8); vo.setStudio_link("/wedding/studio/area8/detail1");
	...
	public void detail2GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(8); vo.setStudio_link("/wedding/studio/area8/detail2");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
	...
	public void detail3GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(8); vo.setStudio_link("/wedding/studio/area8/detail3");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
	...
	public void detail4GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(8); vo.setStudio_link("/wedding/studio/area8/detail4");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
	...
	public void detail5GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(8); vo.setStudio_link("/wedding/studio/area8/detail5");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
	...
	public void detail6GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(8); vo.setStudio_link("/wedding/studio/area8/detail6");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
	...
	public void detail7GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(8); vo.setStudio_link("/wedding/studio/area8/detail7");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
	...
	public void detail8GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(8); vo.setStudio_link("/wedding/studio/area8/detail8");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
