...
public class WeddingHallArea1Controller {
	private static final Logger logger = LoggerFactory.getLogger(WeddingHallArea1Controller.class);
	...
	public void detail1GET(WeddingHallVo vo, Model model) throws Exception {
		...
		vo.setHall_area(1); vo.setHall_link("/wedding/hall/area1/detail1");
	...
	public void detail2GET(WeddingHallVo vo, Model model) throws Exception {
		...
		vo.setHall_area(1); vo.setHall_link("/wedding/hall/area1/detail2");
		WeddingHallVo list = service.SearchAreaHallDetail(vo);
	...
	public void detail3GET(WeddingHallVo vo, Model model) throws Exception {
		...
		vo.setHall_area(1); vo.setHall_link("/wedding/hall/area1/detail3");
		WeddingHallVo list = service.SearchAreaHallDetail(vo);
	...
	public void detail4GET(WeddingHallVo vo, Model model) throws Exception {
		...
		vo.setHall_area(1); vo.setHall_link("/wedding/hall/area1/detail4");
		WeddingHallVo list = service.SearchAreaHallDetail(vo);
	...
	public void detail5GET(WeddingHallVo vo, Model model) throws Exception {
		...
		vo.setHall_area(1); vo.setHall_link("/wedding/hall/area1/detail5");
		WeddingHallVo list = service.SearchAreaHallDetail(vo);
	...
	public void detail6GET(WeddingHallVo vo, Model model) throws Exception {
		...
		vo.setHall_area(1); vo.setHall_link("/wedding/hall/area1/detail6");
		WeddingHallVo list = service.SearchAreaHallDetail(vo);
	...
	public void detail7GET(WeddingHallVo vo, Model model) throws Exception {
		...
		vo.setHall_area(1); vo.setHall_link("/wedding/hall/area1/detail7");
		WeddingHallVo list = service.SearchAreaHallDetail(vo);
	...
	public void detail8GET(WeddingHallVo vo, Model model) throws Exception {
		...
		vo.setHall_area(1); vo.setHall_link("/wedding/hall/area1/detail8");
		WeddingHallVo list = service.SearchAreaHallDetail(vo);
