...
@Controller
@RequestMapping("/wedding/hall/area3/*")
public class WeddingHallArea3Controller {
	private static final Logger logger = LoggerFactory.getLogger(WeddingHallArea3Controller.class);
	...
	public void detail1GET(WeddingHallVo vo, Model model) throws Exception {
		...
		vo.setHall_area(3); vo.setHall_link("/wedding/hall/area3/detail1");
	...
	public void detail2GET(WeddingHallVo vo, Model model) throws Exception {
		...
		vo.setHall_area(3); vo.setHall_link("/wedding/hall/area3/detail2");
		WeddingHallVo list = service.SearchAreaHallDetail(vo);
	...
	public void detail3GET(WeddingHallVo vo, Model model) throws Exception {
		...
		vo.setHall_area(3); vo.setHall_link("/wedding/hall/area3/detail3");
		WeddingHallVo list = service.SearchAreaHallDetail(vo);
	...
	public void detail4GET(WeddingHallVo vo, Model model) throws Exception {
		...
		vo.setHall_area(3); vo.setHall_link("/wedding/hall/area3/detail4");
		WeddingHallVo list = service.SearchAreaHallDetail(vo);
	...
	public void detail5GET(WeddingHallVo vo, Model model) throws Exception {
		...
		vo.setHall_area(3); vo.setHall_link("/wedding/hall/area3/detail5");
		WeddingHallVo list = service.SearchAreaHallDetail(vo);
	...
	public void detail6GET(WeddingHallVo vo, Model model) throws Exception {
		...
		vo.setHall_area(3); vo.setHall_link("/wedding/hall/area3/detail6");
		WeddingHallVo list = service.SearchAreaHallDetail(vo);
	...
	public void detail7GET(WeddingHallVo vo, Model model) throws Exception {
		...
		vo.setHall_area(3); vo.setHall_link("/wedding/hall/area3/detail7");
		WeddingHallVo list = service.SearchAreaHallDetail(vo);
	...
	public void detail8GET(WeddingHallVo vo, Model model) throws Exception {
		...
		vo.setHall_area(3); vo.setHall_link("/wedding/hall/area3/detail8");
		WeddingHallVo list = service.SearchAreaHallDetail(vo);
