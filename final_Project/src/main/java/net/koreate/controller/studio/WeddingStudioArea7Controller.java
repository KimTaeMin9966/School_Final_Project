...
@Controller
@RequestMapping("/wedding/studio/area7/*")
public class WeddingStudioArea7Controller {
	private static final Logger logger = LoggerFactory.getLogger(WeddingStudioArea7Controller.class);
	...
	public void detail1GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(7); vo.setStudio_link("/wedding/studio/area7/detail1");
	...
	public void detail2GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(7); vo.setStudio_link("/wedding/studio/area7/detail2");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
	...
	public void detail3GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(7); vo.setStudio_link("/wedding/studio/area7/detail3");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
	...
	public void detail4GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(7); vo.setStudio_link("/wedding/studio/area7/detail4");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
	...
	public void detail5GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(7); vo.setStudio_link("/wedding/studio/area7/detail5");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
	...
	public void detail6GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(7); vo.setStudio_link("/wedding/studio/area7/detail6");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
	...
	public void detail7GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(7); vo.setStudio_link("/wedding/studio/area7/detail7");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
	...
	public void detail8GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(7); vo.setStudio_link("/wedding/studio/area7/detail8");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
