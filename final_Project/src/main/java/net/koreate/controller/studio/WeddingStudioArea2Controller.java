...
@Controller
@RequestMapping("/wedding/studio/area2/*")
public class WeddingStudioArea2Controller {
	private static final Logger logger = LoggerFactory.getLogger(WeddingStudioArea2Controller.class);
	...
	public void detail1GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(2); vo.setStudio_link("/wedding/studio/area2/detail1");
	...
	public void detail2GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(2); vo.setStudio_link("/wedding/studio/area2/detail2");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
	...
	public void detail3GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(2); vo.setStudio_link("/wedding/studio/area2/detail3");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
	...
	public void detail4GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(2); vo.setStudio_link("/wedding/studio/area2/detail4");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
	...
	public void detail5GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(2); vo.setStudio_link("/wedding/studio/area2/detail5");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
	...
	public void detail6GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(2); vo.setStudio_link("/wedding/studio/area2/detail6");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
	...
	public void detail7GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(2); vo.setStudio_link("/wedding/studio/area2/detail7");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
	...
	public void detail8GET(WeddingStudioVo vo, Model model) throws Exception {
		...
		vo.setStudio_area(2); vo.setStudio_link("/wedding/studio/area2/detail8");
		WeddingStudioVo list = service.SearchAreaStudioDetail(vo);
