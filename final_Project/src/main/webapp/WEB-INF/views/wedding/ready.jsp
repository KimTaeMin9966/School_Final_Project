							...
							<div class="item-inner-wrapper">
								<div class="image-wrapper">
									<a
										...
										<img alt="" data-story-image="" src="${pageContext.request.contextPath}/resources/images/companys.png"
										class="_loaded">
									</a>
								</div>
								<h3 class="title">
							...
							<div class="item-inner-wrapper">
								<div class="image-wrapper">
									<a
										...
										<img alt="" data-story-image="" src="${pageContext.request.contextPath}/resources/images/checklist.png"
										class="_loaded">
									</a>
								</div>
								<h3 class="title">
							...
							<div class="item-inner-wrapper">
								<div class="image-wrapper">
									<a
										...
										<img alt="" data-story-image="" src="${pageContext.request.contextPath}/resources/images/LETTER.png" class="_loaded">
									</a>
								</div>
								<h3 class="title">
									<font style="vertical-align: inherit;"><font
