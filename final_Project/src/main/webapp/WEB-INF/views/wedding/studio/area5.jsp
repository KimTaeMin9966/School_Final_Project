...
<<<<<<< HEAD
				<a class="product-tiles-grid-item-link" href="/wedding/studio/area5/${studios.studio_link}">
=======
				<a class="product-tiles-grid-item-link" href="/wedding/hall/area5/${studios.studio_link}">
