...
<<<<<<< HEAD
				<a class="product-tiles-grid-item-link" href="/wedding/studio/area1/${studios.studio_link}">
=======
				<a class="product-tiles-grid-item-link" href="/wedding/hall/area1/${studios.studio_link}">
