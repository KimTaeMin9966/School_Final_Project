...
<<<<<<< HEAD
				<a class="product-tiles-grid-item-link" href="/wedding/studio/area2/${studios.studio_link}">
=======
				<a class="product-tiles-grid-item-link" href="/wedding/hall/area2/${studios.studio_link}">
