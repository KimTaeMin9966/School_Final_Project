				...
				<header class="style-news-header">
					...
					<h2 class="title">
						<font style="vertical-align: inherit;">
							<font style="vertical-align: inherit;">부산의 대표적인 컨설팅 </font>
						</font>
					</h2>
					<p class="eyebrow"></p>
				</header>
						...
						<div class="panel panel-default panel-front">
							...
							<div class="panel-body">
								...
								<p>All-encompassing of Colorado's most beautiful and
									...
									flowing creeks, and 360-degree mountain views. </p>
								<div class="row">
									<div class="col-xs-6 col-sm-12 col-md-6"></div>
									<div class="col-xs-6 col-sm-12 col-md-6">
										<div class="text-right">
											<a href="https://www.instagram.com/explore/tags/bwcwedding/" rel="nofollow" class="btn btn-info btn-sm" role="button">BWC</a>
										</div>
									</div>
								</div>
							</div>
