...
<div class="content">
	<div class="product-detail-wrap">
		...
		<div class="product-detail-column">
			<section class="product-detail-images">
				<div id="carousel-vertical"
					class="product-detail-carousel carousel-vertical"
					...
					<div class="save-help">
						<a class="save main-product" title="나중에 저장" tabindex="-1"
							data-save-item="5501300V10G6629" aria-pressed="false"> </a>
					</div>
					<!-- .add the save for later icon-->


					<div
						class="product-detail-carouse-vertical-inner carousel-vertical-inner carousel-inner">
						<div
							class="js--zoomcarousel-opener item product-detail-image-slide zoom-in _item-loaded active _active-item-icon _active _active-slide"
							style="height: 758px;" aria-hidden="true" tabindex="-1"
							role="option" aria-describedby="slick-slide00">
							<div class="wrapper-move-down" style="display: none;">
								<span class="arrow-move-down"><font
									style="vertical-align: inherit;"><font
										style="vertical-align: inherit;">아래로 이동</font></font></span>
							</div>
		...
		<input type="hidden" id="addToCartUrl" name="addToCartUrl"
			value="/int/en/cart/ajax/add"> <input type="hidden"
			id="CSRFToken" name="CSRFToken"
			value="d716dee8-7653-4b7c-ab28-b386f6ac1ca0"> <input
			id="product-details-selected-size" name="productCode" type="hidden"
			value="-1">
		<!-- Correct and working html chunk -->
		<div class="purchase-column ">
			<section class="product-detail-purchase"
				...
				<h1 class="product-name product-detail-product-name">
					<font style="vertical-align: inherit;"><font
						style="vertical-align: inherit;">W스퀘어 웨딩홀</font></font>
				</h1>
				<div class="product-action-column save-help">
					<button type="button" class="favorite  main-product"
						data-save-item="5501300V10G6629"
						data-label-saved="Remove from favorites"
						data-label-tosave="Save for later" aria-pressed="false"
						title="나중에 저장">
						<font style="vertical-align: inherit;"><font
							style="vertical-align: inherit;"> 나중에 저장</font></font>
					</button>
				...
				<div class="product-price product-detail-price">
					...
					<!-- <div class="print-column product-detail-print-column">
						<a class="print-link product-detail-print-link"
							href="/int/en/-p-5501300V10G6629/print" target="_blank"><font
							style="vertical-align: inherit;"><font
								style="vertical-align: inherit;">인쇄</font></font></a>
					</div> -->
				</div>
				...
				<div class="product-info-wrapper">
					<div class="product-description-small">
						<div class="description-title-small">
							<font style="vertical-align: inherit;"><font
								style="vertical-align: inherit;"> 기술</font></font>
						</div>
						<div class="description-small">
							<p>Brought back from the 1970s archives, the Double G
								...
								feel. The accessory was presented in the Cruise 2019 collection,
								revealed in the evocative setting of the Promenade des
								Alyscamps, an ancient Roman necropolis in the town of Arles,
								France—which gives the name to the line.</p>
						</div>
						<a class="view-detail-link" href="#"><span class="view">View
								details</span><span class="hide">Hide details</span></a>
						<div class="details">
							<ul>
								...
								<li>Adjustable straps with snap button allow this bag to
									also be carried as a shoulder bag</li>
								<li>Strap drop 5.5" when worn as a top handle bag; 13" when
									carried as a shoulder bag</li>
					...
					<div class="product-style-selector">
						<div class="style-color-material" data-module="styleSelector">
							<a class="styles-link overlay-open"
								href="https://www.google.com/maps"> <span
								class="color-material"> <img alt="GOOGLE MAP"
									src="${pageContext.request.contextPath}/resources/images/구글지도이미지1.png"
									class="_loaded">
							</span> <span class="color-material-name"><font
									style="vertical-align: inherit;"> <font
										style="vertical-align: inherit;">GOOGLE MAP </font></font></span> <span
								class="variations"><font style="vertical-align: inherit;">
										<!-- <font style="vertical-align: inherit;">5 스타일</font></font></span> --></a>
							<input id="styleId" type="hidden" name="styleId" value="1">
						</div>
						<!-- .style-color-material -->
					</div>

					<div class="save-help" data-module="tooltip">
						<ul>
					...
					<div class="product-details-nav">
						<ul>
							<li><a
								class="product-details-nav-product-details scroll-to-accordion"
								href="#accordion-product-details"><font
									style="vertical-align: inherit;"><font
										style="vertical-align: inherit;"> 홀 컨디션 상세정보 보기</font></font></a></li>
						</ul>
					</div>
					<!-- <a class="view-product-link" href="#"> View Product</a>
					<div class="inter-right-buttons">
						<ul data-module="tooltip">
							<li class="inter-tooltip">
								<div class="more-info tooltip-open-hover"
									href="#inter-pdp-tooltip">
									<div class="view-more">
										<span class="tooltip" id="inter-pdp-tooltip"><font
											style="vertical-align: inherit;"><font
												style="vertical-align: inherit;"> 구매 가능 사이트에 액세스하려면
													"국가 변경"을 클릭하십시오.</font></font></span>
									</div>
								</div> <font style="vertical-align: inherit;"><font
									style="vertical-align: inherit;"> 구찌 인터내셔널</font></font>
							</li>
							<li class="inter-product-change-country"><a
								id="inter-ship-to" class="overlay-open"
								href="#header-nav-ship-to"><font
									style="vertical-align: inherit;"><font
										style="vertical-align: inherit;"> 국가 변경</font></font></a></li>
						</ul>
					</div> -->
				...
				<input type="hidden" class="gucciProductName"
					value="Arli large top handle bag"> <input type="hidden"
					class="gucciProductCode" value="5501300V10G6629"> <input
					type="hidden" class="gucciProductPrice" value=""> <input
					type="hidden" class="gucciProductCategory" value="Women/Handbags">
				<input type="hidden" class="gucciProductVariation"
					value="burgundy leather"> <input type="hidden"
					class="gucciProductPostion" value="1"> <input type="hidden"
					class="gucciProductBrand" value=""> <input type="hidden"
					class="gucciProductList" value="ProductGrid"> <input
					type="hidden" class="gucciDimension5" value="non-sale">
			</section>
			<!-- . product-detail-purchase -->

		</div>
		<!-- END Correct and working html chunk -->
		<!-- Product Details Accordian - Left -->
		<div class="detail-accordion" style="min-height: 848px;">
			<section class="product-detail-accordion">
				<div class="accordion-wrapper standard" data-module="accordion">
					<div id="accordion-product-details"
						class="product-details-nav-product-details accordion-item accordion-item-mutually-exclusive accordion-item-default accordion-item-standard accordion-item-medium accordion-item-small _open _ready">

						<picture class="product-thumb">
						<source data-image-size="medium-retina"
							srcset="//media.gucci.com/style/White_Center_0_0_640x360/1533906912/550130_0V10G_6629_001_075_0000_Light-Arli-large-top-handle-bag.jpg"
							media="(min-width: 768px) and (max-width: 1023px) and (-webkit-min-device-pixel-ratio: 2), (min-width: 768px) and (max-width: 1023px) and (min-resolution: 192dpi)">
						<source data-image-size="small-retina"
							srcset="//media.gucci.com/style/White_Center_0_0_730x490/1533906912/550130_0V10G_6629_001_075_0000_Light-Arli-large-top-handle-bag.jpg"
							media="(max-width: 767px) and (-webkit-min-device-pixel-ratio: 2), (max-width: 767px) and (min-resolution: 192dpi)">
						<source data-image-size="standard-retina"
							srcset="//media.gucci.com/style/White_Center_0_0_500x340/1533906912/550130_0V10G_6629_001_075_0000_Light-Arli-large-top-handle-bag.jpg"
							media="(min-width: 1024px) and (-webkit-min-device-pixel-ratio: 2), (min-width: 1024px) and (min-resolution: 192dpi)">
						<source data-image-size="medium"
							srcset="//media.gucci.com/style/White_Center_0_0_320x180/1533906912/550130_0V10G_6629_001_075_0000_Light-Arli-large-top-handle-bag.jpg"
							media="(min-width: 768px) and (max-width: 1023px)">
						<source data-image-size="small"
							srcset="//media.gucci.com/style/White_Center_0_0_365x245/1533906912/550130_0V10G_6629_001_075_0000_Light-Arli-large-top-handle-bag.jpg"
							media="(max-width: 767px)">
						<source data-image-size="standard"
							srcset="//media.gucci.com/style/White_Center_0_0_250x170/1533906912/550130_0V10G_6629_001_075_0000_Light-Arli-large-top-handle-bag.jpg"
							media="(min-width: 1024px)">
						<img data-image-type="fallback"
							srcset="//media.gucci.com/style/White_Center_0_0_250x170/1533906912/550130_0V10G_6629_001_075_0000_Light-Arli-large-top-handle-bag.jpg"
							alt="Arli large top handle bag" class=""></picture>

						<h2 class="accordion-button">
							<a href="#product-details"><font
								style="vertical-align: inherit;"><font
									style="vertical-align: inherit;">홀 컨디션 상세정보</font></font></a>
						</h2>
						<div class="accordion-drawer" id="product-details" style="">
							<div class="product-detail columnize-by-2">
								<p>Brought back from the 1970s archives, the Double G
									hardware defines a new line of handbags. The oversize emblem
									decorates the front of a leather tote, designed with a vintage
									feel. The accessory was presented in the Cruise 2019
								...
								<ul>
									...
									<li>Adjustable straps with snap button allow this bag to
										also be carried as a shoulder bag</li>
									<li>Strap drop 5.5" when worn as a top handle bag; 13"
										when carried as a shoulder bag</li>
									<li>14.5"W x 7.5"H x 3.5"D</li>
									<li>Made in Italy</li>
								</ul>
							</div>
						...
						<a class="print-link product-detail-print-link"
							href="/int/en/-p-5501300V10G6629/print" target="_blank"
