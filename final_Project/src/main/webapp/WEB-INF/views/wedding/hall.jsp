				...
				<header class="style-news-header">
					...
					<h2 class="title">
						<font style="vertical-align: inherit;">
							<font style="vertical-align: inherit;">부산의 대표적인 웨딩홀 </font>
						</font>
					</h2>
					<p class="eyebrow"></p>
				</header>
				<div class="row">
					<div class="col col-xs-12 col-sm-4 col-md-4 col-lg-4 ">
						<div class="panel panel-default panel-front">
							...
							<div class="panel-body">
								<a href="/wedding/hall/area1"><h3>진구 웨딩홀</h3></a>
								...
								<div class="row">
									...
									<div class="col-xs-6 col-sm-12 col-md-6">
										<div class="text-center">
											<a href="/wedding/hall/area1" rel="nofollow" class="btn btn-info btn-sm" role="button">진구웨딩홀</a>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col col-xs-12 col-sm-4 col-md-4 col-lg-4 ">
						<div class="panel panel-default panel-front">
							...
							<div class="panel-body">
								<a href="/wedding/hall/area2"><h3>동구 웨딩홀</h3></a>
								...
								<div class="row">
									...
									<div class="col-xs-6 col-sm-12 col-md-6">
										<div class="text-center">
											<a href="/wedding/hall/area2" rel="nofollow" class="btn btn-info btn-sm" role="button">동구 웨딩홀</a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="panel panel-default panel-front">
							...
							<div class="panel-body">
								...
								<div class="row">
									...
									<div class="col-xs-6 col-sm-12 col-md-6">
										<div class="text-center">
											<a href="/wedding/hall/area3" rel="nofollow" class="btn btn-info btn-sm" role="button">해운대구 웨딩홀</a>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="row">
						...
						<div class="panel panel-default panel-front">
							...
							<div class="panel-body">
								...
								<p>All-encompassing of Colorado's most beautiful and
									...
									flowing creeks, and 360-degree mountain views.
								<div class="row">
									<div class="col-xs-6 col-sm-12 col-md-6"></div>
									<div class="col-xs-6 col-sm-12 col-md-6">
										<div class="text-center">
											<a href="/wedding/hall/area4" rel="nofollow" class="btn btn-info btn-sm" role="button">동래구 웨딩홀</a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="panel panel-default panel-front">
							...
							<div class="panel-body">
								...
								<div class="row">
									...
									<div class="col-xs-6 col-sm-12 col-md-6">
										<div class="text-center">
											<a href="/wedding/hall/area5" rel="nofollow" class="btn btn-info btn-sm" role="button">연제구 웨딩홀</a>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col col-xs-12 col-sm-4 col-md-4 col-lg-4 ">
						<div class="panel panel-default panel-front">
							...
							<div class="panel-body">
								<a href="/wedding/hall/area6"><h3>중구 웨딩홀</h3></a>
								...
								<div class="row">
									...
									<div class="col-xs-6 col-sm-12 col-md-6">
										<div class="text-center">
											<a href="/wedding/hall/area6" rel="nofollow" class="btn btn-info btn-sm" role="button">중구 웨딩홀</a>
										</div>
									</div>
								</div>
							</div>
